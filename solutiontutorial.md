# IBM Cloud ソリューション・チュートリアル

この資料では、IBM Cloud上に様々なパターンのソリューションを構築する例をStep by Stepで紹介しています。
...
- Webサイト/Webアプリケーション
  ...
  - [Serverless Web application and API](cloudsolutiontutorial/Web Site and Web Application/Serverless web application and API.md)
